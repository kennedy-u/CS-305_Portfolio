...
public class SslServerController {
    ...
    public String checksum(@RequestParam(value = "data", defaultValue = "Hello World, Check Sum. Welcome to a safe browsing environment!")
	String data) throws NoSuchAlgorithmException{
    	// Declare constants with data to encrypt and the cipher to use.
    	final String name = "Kennedy Uzoho", algorithmCipher = "SHA-512";
